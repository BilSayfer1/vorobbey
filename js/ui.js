...
export function reloadPosts(arr, arr2, arr3, place) {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        postlikeCounter.innerHTML = '8,887 likes'
        ...
        postBotLike.onclick = () => {
            if (active2 === false) {
                ...
                active2 = true
                postlikeCounter.innerHTML = '8,888 likes'
            } else {
                postLikeImg.src = './icons/like.png'
                active2 = false
                postlikeCounter.innerHTML = '8,887 likes'
        ...
        postModalLike.onclick = () => {
            if (active5 === false) {
                ...
                active5 = true
                document.querySelector('.content-data span').innerHTML = "Liked by 8,888 people"
            } else {
                postModalLike.src = './icons/like.png'
                active5 = false
                document.querySelector('.content-data span').innerHTML = "Liked by 8,887 people"
            }
        }
